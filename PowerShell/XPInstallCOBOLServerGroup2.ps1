...
# COBOL Server Serial# 600000555095
...
else { write-host "C:\Documents and Settings\All Users\Desktop\New Minerals & Utilities already exists.." }
write-host
# Copy Micro Focus COBOL Server license 2372722.mflic to desktop to be used in Micro Focus License Manager
Write-host "Copying COBOL Server License to Desktop....."
Get-ExecutionPolicy 
copy-item -path "\\App1\c$\Users\administrator.TYPDAL\Documents\Micro Focus COBOL - Product and Licenses\Serial# 600000555095\2372722.mflic" -Destination "C:\Documents and Settings\All Users\Desktop\"
write-host
...
$newPath=$oldPath+’;C:\Program Files\Micro Focus\COBOL Server\bin’
Set-ExecutionPolicy -ExecutionPolicy Unrestricted -force
